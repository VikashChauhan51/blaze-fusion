...
/// <summary>
/// Provides a binding from the DOM element to the Blaze action
/// </summary>
[HtmlTargetElement("blaze", Attributes = NameAttribute, TagStructure = TagStructure.WithoutEndTag)]
public sealed class BlazeComponentTagHelper : TagHelper
{
    ...
    /// <summary>
    /// Blaze component's action to execute
    /// </summary>
    [HtmlAttributeName(NameAttribute)]
    public string Name { get; set; }

    /// <summary>
    /// Key of the component. Use it to distinguish same Blaze components on the same view 
    /// </summary>
